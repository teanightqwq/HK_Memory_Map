...
├── ADMIN_GUIDE.md                  # 👨‍💼 管理員使用指南
├── ADMIN_REVIEW_GUIDE.md           # 📋 審核流程指南
├── GOOGLE_MAPS_GUIDE.md            # 🗺️ Google Maps 使用教學
├── ACHIEVEMENT_CLEANUP.md          # 🏆 成就系統文檔
├── TROUBLESHOOTING.md              # 🔧 問題排查指南
│
├── images/                         # 🖼️ 圖片資源文件夾
│   └── placeholder.svg             # 測試用占位圖片
│
├── pages/                          # 📄 頁面文件夾
│   ├── login.html                  # 🔐 登入頁面
│   ├── register.html               # 📝 註冊頁面
│   ├── map.html                    # 🗺️ 記憶地圖（公共地圖）
│   ├── upload.html                 # 📸 上傳記憶頁面
│   ├── collection.html             # 🧩 我的收藏頁面
│   ├── achievements.html           # 🏆 成就系統頁面
│   ├── leaderboard.html            # � 排行榜頁面
│   ├── dev-tools.html              # 🛠️ 開發工具頁面
│   └── admin/                      # 👨‍💼 管理員後台
│       ├── login.html              # 管理員登入
│       ├── dashboard.html          # 數據總覽儀表板
│       ├── review.html             # 提交審核頁面
│       ├── fragments.html          # 碎片管理頁面
│       ├── cards.html              # 記憶卡管理頁面
│       ├── users.html              # 用戶管理頁面
│       ├── categories.html         # 分類管理頁面
│       └── settings.html           # 系統設置頁面
│
├── scripts/                        # 📜 JavaScript 腳本文件夾
│   ├── main.js                     # 主頁腳本
│   ├── auth.js                     # 用戶認證腳本
│   ├── register.js                 # 註冊腳本
│   ├── map.js                      # 地圖功能腳本
...
│   ├── dev-tools.js                # 開發工具腳本
│   ├── init-test-data.js           # 測試數據初始化腳本
│   ├── map-modal-compact.js        # 地圖彈窗精簡版（備用）
│   └── admin-*.js                  # 管理員功能腳本
│       ├── admin-auth.js           # 管理員認證
│       ├── admin-dashboard.js      # 儀表板功能
│       ├── admin-review.js         # 審核功能
│       ├── admin-fragments.js      # 碎片管理
│       ├── admin-cards.js          # 卡片管理
│       ├── admin-users.js          # 用戶管理
│       ├── admin-categories.js     # 分類管理
│       └── admin-settings.js       # 系統設置
│
└── styles/                         # 🎨 CSS 樣式文件夾
    ├── main.css                    # 主樣式表（用戶端）
    └── admin.css                   # 管理員樣式表
